...
struct BrailleParallelParams {
    ...
    drops_ptr: *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const [RainDrop; DROPS_PER_COLUMN],
    col_depth_ptr: *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const u8,
    num_cols: usize,
