...
unsafe { core::arch::x86_64::__cpuid_count(7, 0) };
            ...
            let cpuid_ext = // SÉCURITÉ : Bloc unsafe — contourne les garanties mémoire de Rust. Vérifier les invariants manuellement.
...
const SMEP: u64 = 1 << 20;  // Supervisor Mode Execution Prevention
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
