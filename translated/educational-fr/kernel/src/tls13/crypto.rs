...
pub fn x25519(k: &[u8; 32], u: &[u8; 32]) -> [u8; 32] {
    ...
    for i in (0..255).rev() {
        ...
        let choice = (previous_bit ^ cur_bit) as u64;
        ...
        previous_bit = cur_bit;
    }
    
    // Final swap based on the LSB (bit 0)
    let final_swap = previous_bit as u64;
...
pub(crate) // Alias de type — donne un nouveau nom à un type existant pour la clarté.
type Fe = [u64; 5];
