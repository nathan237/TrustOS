...
pub fn adjust_vmx_control(msr: u32, desired: u32) -> u32 {
    ...
    let must_be_1 = msr_value as u32;        // Low 32 bits
    let may_be_1 = (msr_value >> 32) as u32; // High 32 bits
...
pub fn virt_to_physical_vmx(virt: u64) -> u64 {
    crate::memory::virt_to_physical(virt).unwrap_or(virt)
}
...
pub fn vmxon() -> Result<()> {
    ...
    let region_virt = region.as_ref() as *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
