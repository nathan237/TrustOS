...
pub fn get_dashboard() -> String {
    ...
    let mon = // Correspondance de motifs — branchement exhaustif de Rust.
...
match category {
        ...
        DebugCategory::CrWrite => // Correspondance de motifs — branchement exhaustif de Rust.
match id {
            0 => String::from("CR0"),
            3 => String::from("CR3"),
            4 => String::from("CR4"),
        ...
        DebugCategory::Exception => // Correspondance de motifs — branchement exhaustif de Rust.
match id {
