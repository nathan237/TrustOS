...
pub mod esr_class {
    ...
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const DATA_ABORT_LOWER: u32 = 0b100100;
    /// HVC from EL1
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const HVC64: u32 = 0b010110;
    /// SMC from EL1 (trapped by TSC)
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const SMC64: u32 = 0b010111;
    /// System register access (trapped by TVM, etc.)
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const MSR_MRS: u32 = 0b011000;
    /// WFI/WFE trapped (TWI/TWE)
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const WFX: u32 = 0b000001;
    /// Instruction Abort from lower EL
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const INST_ABORT_LOWER: u32 = 0b100000;
}
