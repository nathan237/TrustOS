...
const UIE: u64 = 1 << 1;
    ...
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const LRENPIE: u64 = 1 << 2;
    /// No Pending Interrupt Enable
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const NPIE: u64 = 1 << 3;
    /// VGRP0 Enable
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const VGRP0EIE: u64 = 1 << 4;
    /// VGRP1 Enable
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const VGRP1EIE: u64 = 1 << 5;
...
pub mod ich_lr {
    ...
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const STATE_INVALID: u64 = 0b00 << 62;   // bits [63:62] = State, shifted by 1
    /// State: Pending
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const STATE_PENDING: u64 = 0b01 << 60;
    /// State: Active
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const STATE_ACTIVE: u64 = 0b10 << 60;
    /// State: Pending + Active
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const STATE_PEND_ACT: u64 = 0b11 << 60;
...
pub fn handle_el2_interrupt_request(vgic: &mut VirtualGic) {
    #[cfg(target_arch = "aarch64")]
    {
