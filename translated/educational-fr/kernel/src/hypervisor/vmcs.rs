...
impl Vmcs {
    ...
    pub fn new(revision_id: u32) -> Result<Self> {
        ...
        let virt_addr = region.as_ref() as *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
...
unsafe {
        ...
        let gdt_ptr = gdtr.base as *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const u64;
