...
const MAXIMUM_BUFFER_SIZE: usize = 4096;
...
pub fn new(id: u32, name: &str) -> Self {
        Self {
            ...
            input_buffer: VecDeque::with_capacity(MAXIMUM_BUFFER_SIZE),
            output_buffer: VecDeque::with_capacity(MAXIMUM_BUFFER_SIZE),
            on_data: None,
        }
    }
    ...
    pub(crate) fn receive(&mut self, data: &[u8]) {
        for &byte in data {
            if self.input_buffer.len() < MAXIMUM_BUFFER_SIZE {
