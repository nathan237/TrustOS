...
pub // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const GL_TEXTURE_MINIMUM_FILTER: u32 = 0x2801;
pub // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
...
pub fn gl_generator_textures(n: i32, textures: &mut [u32]) {
...
pub fn gl_tex_parameteri(target: u32, pname: u32, parameter: u32) {
    ...
    let tex_id = // Correspondance de motifs — branchement exhaustif de Rust.
match target {
