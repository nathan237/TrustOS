...
impl GbBus) -> u16 {
    ...
    fn get_reg(&self, r: u8, bus: &mut // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl GbBus) -> u8 {
...
match r & 7 {
    ...
    fn set_reg(&mut self, r: u8, v: u8, bus: &mut // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl GbBus) {
                // Correspondance de motifs — branchement exhaustif de Rust.
match r & 7 {
...
match op {
    ...
    fn execute_cb(&mut self, bus: &mut // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl GbBus) -> u32 {
