...
impl RadioButton {
        // Fonction publique — appelable depuis d'autres modules.
pub fn new(label: // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl Into<String>, group: u32) -> Self {
        Self {
            id: next_widget_id(),
            bounds: Rect::ZERO,
            state: WidgetState::new(),
...
impl Modal {
        // Fonction publique — appelable depuis d'autres modules.
pub fn new(title: // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl Into<String>, width: u32, height: u32) -> Self {
        Self {
            id: next_widget_id(),
            bounds: Rect::ZERO,
            state: WidgetState::new(),
...
impl Widget for Modal {
    ...
    fn render(&self, surface: &mut GpuSurface, theme: &Theme) {
        ...
        let (software, sh) = (surface.width, surface.height);
...
pub fn new() -> Self {
        ...
        // Fonction publique — appelable depuis d'autres modules.
pub fn with_title(mut self, title: // Bloc d'implémentation — définit les méthodes du type ci-dessus.
...
pub fn new(icon: char) -> Self {
        ...
        // Fonction publique — appelable depuis d'autres modules.
pub fn with_tooltip(mut self, tooltip: // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl Into<String>) -> Self {
...
impl Tooltip {
        // Fonction publique — appelable depuis d'autres modules.
pub fn new(text: // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl Into<String>) -> Self {
        Self {
            text: text.into(),
            x: 0,
