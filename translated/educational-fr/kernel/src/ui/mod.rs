...
impl Widget for Label {
    ...
    fn render(&self, surface: &mut GpuSurface, theme: &Theme) {
        ...
        let x = // Correspondance de motifs — branchement exhaustif de Rust.
match self.align {
...
pub fn new() -> Self {
        ...
        // Fonction publique — appelable depuis d'autres modules.
pub fn with_placeholder(mut self, placeholder: // Bloc d'implémentation — définit les méthodes du type ci-dessus.
impl Into<String>) -> Self {
...
match self.direction {
        ...
        let main_size = // Correspondance de motifs — branchement exhaustif de Rust.
match self.direction {
