...
pub fn normalize_url(url: &str, base: &str) -> String {
    ...
    let is_bare_domain = has_dot && // Correspondance de motifs — branchement exhaustif de Rust.
match (first_dot, first_slash) {
    ...
    let (host, base_path) = // Correspondance de motifs — branchement exhaustif de Rust.
match base.find('/') {
