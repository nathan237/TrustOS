...
const FUTEX_CMP_REQUEUE: u32 = 4;
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const FUTEX_WAKE_OPERATION: u32 = 5;
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
...
const FUTEX_CLOCK_REALTIME: u32 = 256;
    ...
    pub     // Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const FUTEX_COMMAND_MASK: u32 = !(FUTEX_PRIVATE_FLAG | FUTEX_CLOCK_REALTIME);
}
...
unsafe { 
        let ptr = uaddr as *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const AtomicU32;
