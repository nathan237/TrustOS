...
macro_rules! log_level {
    ($level:expr, $($argument:tt)*) => {
        $crate::logger::_log($level, format_args!($($argument)*))
    };
}
...
macro_rules! log_debug {
    ($($argument:tt)*) => {
        $crate::log_level!($crate::logger::LogLevel::Debug, $($argument)*)
    };
}
...
macro_rules! log_warn {
    ($($argument:tt)*) => {
        $crate::log_level!($crate::logger::LogLevel::Warn, $($argument)*)
    };
}
...
macro_rules! log_error {
    ($($argument:tt)*) => {
        $crate::log_level!($crate::logger::LogLevel::Error, $($argument)*)
    };
}
