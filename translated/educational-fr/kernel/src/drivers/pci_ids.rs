...
match device_id {
        ...
        // Red Hat (QEMU)
        0x1AF4 => // Correspondance de motifs — branchement exhaustif de Rust.
match device_id {
        ...
        // QEMU
        0x1234 => // Correspondance de motifs — branchement exhaustif de Rust.
match device_id {
        ...
        // Realtek
        0x10EC => // Correspondance de motifs — branchement exhaustif de Rust.
match device_id {
        ...
        // AMD/ATI
        0x1002 => // Correspondance de motifs — branchement exhaustif de Rust.
match device_id {
        ...
        // VirtualBox
        0x80EE => // Correspondance de motifs — branchement exhaustif de Rust.
match device_id {
        ...
        // VMware
        0x15AD => // Correspondance de motifs — branchement exhaustif de Rust.
match device_id {
