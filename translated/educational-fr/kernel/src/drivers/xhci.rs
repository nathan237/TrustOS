...
const u16);
            ...
            dev.vendor_id = ptr::read_unaligned(buffer_virt.add(8) as *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const u16);
            dev.product_id = ptr::read_unaligned(buffer_virt.add(10) as *// Constante de compilation — évaluée à la compilation, coût zéro à l'exécution.
const u16);
