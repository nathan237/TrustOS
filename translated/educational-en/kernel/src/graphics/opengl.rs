...
impl GlState {
    ...
    fn current_matrix(&mut self) -> &mut Mat4 {
        let stack = // Pattern matching — Rust's exhaustive branching construct.
...
pub fn gl_initialize(width: u32, height: u32) {
...
pub fn demo_initialize_checkerboard_texture(tex_id: &mut u32) {
    texture::gl_generator_textures(1, core::slice::from_mut(tex_id));
    ...
    texture::gl_tex_parameteri(texture::GL_TEXTURE_2D, texture::GL_TEXTURE_MINIMUM_FILTER, texture::GL_NEAREST);
}
