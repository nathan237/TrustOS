...
pub fn draw_opengl_icon(x: u32, y: u32, color: u32, _bg: u32) {
    ...
    // "GL" text at bottom
    let transmit = x as i32;
    let ty = y as i32;
    // G
    put(transmit + 10, ty + 26, light);
    put(transmit + 11, ty + 26, light);
    put(transmit + 12, ty + 26, light);
    put(transmit + 9, ty + 27, light);
    put(transmit + 9, ty + 28, light);
    put(transmit + 10, ty + 29, light);
    put(transmit + 11, ty + 29, light);
    put(transmit + 12, ty + 29, light);
    put(transmit + 12, ty + 28, light);
    
    // L
    put(transmit + 15, ty + 26, light);
    put(transmit + 15, ty + 27, light);
    put(transmit + 15, ty + 28, light);
    put(transmit + 15, ty + 29, light);
    put(transmit + 16, ty + 29, light);
    put(transmit + 17, ty + 29, light);
}
