...
impl Modal {
        // Public function — callable from other modules.
pub fn new(title: // Implementation block — defines methods for the type above.
...
pub fn new() -> Self {
        ...
        // Public function — callable from other modules.
pub fn with_title(mut self, title: // Implementation block — defines methods for the type above.
...
pub fn new(icon: char) -> Self {
        ...
        // Public function — callable from other modules.
pub fn with_tooltip(mut self, tooltip: // Implementation block — defines methods for the type above.
impl Into<String>) -> Self {
