...
pub fn new(sandbox_id: SandboxId, config: JsSandboxConfig) -> Self {
    ...
    pub fn execute(&mut self, code: &str) -> JsExecuteResult {
        ...
        let return_str = // Pattern matching — Rust's exhaustive branching construct.
match &result {
...
loop {
            ...
            let start_tag = // Pattern matching — Rust's exhaustive branching construct.
match lower.find("<script") {
            ...
            let content_start = // Pattern matching — Rust's exhaustive branching construct.
match html[start_tag..].find('>') {
            ...
            // Find closing </script>
            let end_tag = // Pattern matching — Rust's exhaustive branching construct.
