...
match chunk_type {
    ...
    let channels = // Pattern matching — Rust's exhaustive branching construct.
match color_type {
        0 => 1, // Grayscale
        2 => 3, // RGB
        4 => 2, // Gray + Alpha
    ...
    let decompressed = // Pattern matching — Rust's exhaustive branching construct.
...
match filter_type {
        ...
        for x in 0..width as usize {
            ...
            let pixel = // Pattern matching — Rust's exhaustive branching construct.
match channels {
                1 => {
                    // Grayscale
