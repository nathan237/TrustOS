...
match data[7] {
        ...
        elf_type:         // Pattern matching — Rust's exhaustive branching construct.
match e_type {
            1 => "REL (Relocatable)",
            2 => "EXEC (Executable)",
            3 => "DYN (Shared/PIE)",
        ...
        machine:         // Pattern matching — Rust's exhaustive branching construct.
match e_machine {
            62 => "x86-64",
            3 => "x86 (i386)",
            40 => "ARM",
...
fn parse_symbol_table(data: &[u8], sections: &[Section], table_type: u32) -> Vec<Symbol> {
    ...
    let symtab = // Pattern matching — Rust's exhaustive branching construct.
...
fn parse_dynamic(data: &[u8], sections: &[Section]) -> (Vec<DynamicEntry>, Vec<String>) {
    ...
    let dyn_section = // Pattern matching — Rust's exhaustive branching construct.
