...
const u8);
    ...
    let kernel_end = &__kernel_end as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u8 as u64;
...
match soc {
            ...
            if let Some(ref sfb) = parsed.simplefb {
                ...
                let bpp = // Pattern matching — Rust's exhaustive branching construct.
