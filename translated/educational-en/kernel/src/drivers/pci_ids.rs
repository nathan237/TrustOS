...
match device_id {
        ...
        // Red Hat (QEMU)
        0x1AF4 => // Pattern matching — Rust's exhaustive branching construct.
match device_id {
        ...
        // QEMU
        0x1234 => // Pattern matching — Rust's exhaustive branching construct.
match device_id {
        ...
        // Realtek
        0x10EC => // Pattern matching — Rust's exhaustive branching construct.
match device_id {
        ...
        // AMD/ATI
        0x1002 => // Pattern matching — Rust's exhaustive branching construct.
match device_id {
        ...
        // VirtualBox
        0x80EE => // Pattern matching — Rust's exhaustive branching construct.
match device_id {
        ...
        // VMware
        0x15AD => // Pattern matching — Rust's exhaustive branching construct.
match device_id {
