...
unsafe {
            core::ptr::read_unaligned(buf.as_ptr() as *// Compile-time constant — evaluated at compilation, zero runtime cost.
...
unsafe {
                                core::ptr::read_unaligned(
                                    buf[data_start..].as_ptr() as *// Compile-time constant — evaluated at compilation, zero runtime cost.
...
unsafe {
                                core::ptr::read_unaligned(
                                    buf[offset + 16..].as_ptr() as *// Compile-time constant — evaluated at compilation, zero runtime cost.
...
unsafe {
                core::ptr::read_unaligned(data[pos..].as_ptr() as *// Compile-time constant — evaluated at compilation, zero runtime cost.
...
unsafe {
                            core::ptr::read_unaligned(
                                fn_data.as_ptr() as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const FileNameAttribute
                            )
                        };
...
unsafe { core::ptr::read_unaligned(boot_buffer.as_ptr() as *// Compile-time constant — evaluated at compilation, zero runtime cost.
...
unsafe {
                    core::ptr::read_unaligned(
                        mft0_buffer[off + 16..].as_ptr() as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const NonResidentAttributeHeader
                    )
                };
