...
impl DmesgBuffer {
    ...
    fn iter_ordered(&self) -> // Implementation block — defines methods for the type above.
...
unsafe {
                    ...
                    core::ptr::read_volatile((addr + offset + i) as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u8)
                };
