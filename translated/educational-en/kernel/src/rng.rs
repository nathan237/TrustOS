...
pub fn init() {
    ...
    let rdrand = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe {
        let ecx: u32;
    ...
    let rdrand = false;
    #[cfg(target_arch = "x86_64")]
    let rdseed = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe {
        let ebx_out: u32;
