...
const MAXIMUM_TRACKED_ENTRIES: usize = 256;
/// Maximum timeline entries
const MAXIMUM_TIMELINE: usize = 512;
/// Maximum gap entries per category
const MAXIMUM_GAPS: usize = 128;
...
pub fn get_dashboard() -> String {
    ...
    let mon = // Pattern matching — Rust's exhaustive branching construct.
...
match category {
        ...
        DebugCategory::CrWrite => // Pattern matching — Rust's exhaustive branching construct.
match id {
            0 => String::from("CR0"),
            3 => String::from("CR3"),
            4 => String::from("CR4"),
        ...
        DebugCategory::Exception => // Pattern matching — Rust's exhaustive branching construct.
match id {
