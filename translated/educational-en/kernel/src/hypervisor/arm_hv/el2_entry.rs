...
static mut GUEST_CONTEXT: GuestContext = GuestContext {
    x: [0; 31],
    sp_el1: 0,
    elr_el1: 0,
    spsr_el1: 0,
...
unsafe {
    ...
    unsafe {
        GUEST_CONTEXT.x[0] = config.guest_dtb;    // x0 = DTB pointer (Linux convention)
        GUEST_CONTEXT.elr_el1 = config.guest_entry;  // Entry point
        GUEST_CONTEXT.spsr_el1 = 0x3C5;              // EL1h, DAIF masked
    }
