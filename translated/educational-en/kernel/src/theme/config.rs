...
pub fn parse_theme_file(path: &str) -> Option<Theme> {
    // Read file from VFS
    let content = // Pattern matching — Rust's exhaustive branching construct.
...
match section {
        "theme" | "general" => // Pattern matching — Rust's exhaustive branching construct.
match key {
...
match key {
        ...
        "taskbar" => // Pattern matching — Rust's exhaustive branching construct.
match key {
            "height" => {
            ...
            "position" => {
                theme.taskbar.position = // Pattern matching — Rust's exhaustive branching construct.
match value.trim() {
        ...
        "window" | "windows" => // Pattern matching — Rust's exhaustive branching construct.
match key {
            "titlebar_height" => {
                if let Some(h) = parse_u32(value) {
        ...
        "wallpaper" => // Pattern matching — Rust's exhaustive branching construct.
match key {
            "path" | "file" => theme.wallpaper.path = String::from(value),
            "mode" => {
                theme.wallpaper.mode = // Pattern matching — Rust's exhaustive branching construct.
match value.trim() {
