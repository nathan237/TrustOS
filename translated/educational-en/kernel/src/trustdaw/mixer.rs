...
fn render_track(track: &Track, bpm: u32, start_tick: u32, total_samples: usize) -> Vec<i32> {
    ...
    let mut temporary_stereo = vec![0i16; 2]; // Single sample stereo buffer
    ...
    for sample in 0..total_samples {
        ...
        engine.render(&mut temporary_stereo, 1);
        // Take the mono mix (average of L+R)
        buffer[sample] = (temporary_stereo[0] as i32 + temporary_stereo[1] as i32) / 2;
    }
