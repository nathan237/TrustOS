...
unsafe { core::ptr::read_volatile(addr as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u32) })
}
...
pub fn enable_msix(dev: &PciDevice, vector: u8) -> Option<u8> {
    ...
    let bar_addr = // Pattern matching — Rust's exhaustive branching construct.
