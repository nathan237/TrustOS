...
pub fn initialize_subsystem_capabilities() {
...
pub fn gate_check(
    ...
    let cap_id = // Pattern matching — Rust's exhaustive branching construct.
match SUBSYSTEM_CAPS.lock().get(&subsystem).copied() {
        Some(id) => id,
        None => {
...
pub fn gate_shell_execute() -> Result<(), super::SecurityError> {
