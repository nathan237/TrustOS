...
unsafe {
        ...
        let block_pointer = &PERCPU_BLOCKS[0] as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const _ as u64;
...
unsafe {
        ...
        // Set up GS base
        let block_pointer = &PERCPU_BLOCKS[cpu_id as usize] as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const _ as u64;
...
pub fn iterator_cpus() -> // Implementation block — defines methods for the type above.
...
const NONE: Option<()> = None;
        Self {
            data: UnsafeCell::new([// Compile-time constant — evaluated at compilation, zero runtime cost.
