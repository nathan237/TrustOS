...
pub fn from_rom(data: &[u8]) -> Option<Self> {
        ...
        let mbc_type = // Pattern matching — Rust's exhaustive branching construct.
match cart_type {
        ...
        // ROM size ($0148)
        let rom_size = // Pattern matching — Rust's exhaustive branching construct.
match data[0x148] {
            0 => 32 * 1024,
            1 => 64 * 1024,
            2 => 128 * 1024,
        ...
        // RAM size ($0149)
        let ram_size = // Pattern matching — Rust's exhaustive branching construct.
match data[0x149] {
            0 => 0,
            1 => 2 * 1024,
            2 => 8 * 1024,
