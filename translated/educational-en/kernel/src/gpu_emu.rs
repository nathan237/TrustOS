...
pub // Type alias — gives an existing type a new name for clarity.
type ComputeShaderFn = fn(global_id: u32, local_id: u32, uniforms: *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u8) -> u32;
...
pub fn shader_matrix_shapes(input: PixelInput) -> PixelOutput {
    ...
    let (shape_r, shape_g, shape_b) = // Pattern matching — Rust's exhaustive branching construct.
match hit_shape {
