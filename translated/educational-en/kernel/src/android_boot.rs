...
unsafe {
            core::slice::from_raw_parts(
                self as *const Self as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u8,
...
unsafe fn validate(ptr: *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u8) -> bool {
        if ptr.is_null() {
            return false;
        }
        let magic = u32::from_be((ptr as *// Compile-time constant — evaluated at compilation, zero runtime cost.
