...
impl CpuCapabilities {
    ...
    pub fn detect() -> Self {
        ...
        let cpuid_0 = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe { core::arch::x86_64::__cpuid(0) };
        ...
        caps.vendor = // Pattern matching — Rust's exhaustive branching construct.
match &vendor_str {
        ...
        if maximum_basic_leaf >= 1 {
            let cpuid_1 = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe { core::arch::x86_64::__cpuid(1) };
        ...
        if maximum_basic_leaf >= 7 {
            let cpuid_7 = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe { core::arch::x86_64::__cpuid_count(7, 0) };
        ...
        // Extended CPUID
        let cpuid_ext_maximum = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe { core::arch::x86_64::__cpuid(0x80000000) };
        ...
        if maximum_ext_leaf >= 0x80000001 {
            let cpuid_ext1 = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe { core::arch::x86_64::__cpuid(0x80000001) };
        ...
        if maximum_ext_leaf >= 0x80000007 {
            let cpuid_ext7 = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
unsafe { core::arch::x86_64::__cpuid(0x80000007) };
        ...
        if maximum_ext_leaf >= 0x80000004 {
            for i in 0..3 {
                let cpuid_brand = // SAFETY: Unsafe block — bypasses Rust memory-safety guarantees. Ensure invariants manually.
