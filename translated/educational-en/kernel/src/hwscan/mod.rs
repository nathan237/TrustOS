...
unsafe {
            if let Some(parsed) = dtb_parser::parse_dtb(dtb_addr as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u8) {
...
const u8) {
                ...
                for dev in &parsed.devices {
                    ...
                    let ptr = dev.reg_base as *// Compile-time constant — evaluated at compilation, zero runtime cost.
const u32;
