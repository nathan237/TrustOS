...
fn decode_gic_distributor(base: u64) -> String {
    ...
    if let Some(iidr) = safe_read(base + GICD_IIDR) {
        ...
        let impl_name = // Pattern matching — Rust's exhaustive branching construct.
match implementer {
            0x43B => "ARM",
            0x42 => "Broadcom",
            0x51 => "Qualcomm",
...
pub fn scan_interrupt_request_topology() -> String {
